package com.italkbb.imetis.okhttp3.response;
...
import com.italkbb.imetis.okhttp3.utils.JsonHelper;
...
public class FileUploadCallback implements Callback {
    ...
    private String handleResponse(Response response) {
        ...
        try {
            ...
            com.italkbb.imetis.okhttp3.model.Response rsp = JsonHelper.parseJSON(result, String.class);
            if (rsp != null) {
